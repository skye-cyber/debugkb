...
// Placeholder data — will be replaced by react-query later
const stats = [
...
const recent = [
  ...
  {
    id: "ISSUE-2026-002",
    title: "Nginx timeout on large file uploads",
    severity: "medium",
    status: "unresolved",
    priority: 6.2,
    tags: ["nginx", "uploads"],
            ...
            {recent.map((issue) => (
              <li key={issue.id}>
                ...
                >
                  ...
                  <div className="flex items-start text-sm font-medium mb-2 line-clamp-1">
                    {issue.title}
                  </div>
